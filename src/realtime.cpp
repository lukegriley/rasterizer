...
void Realtime::initializeGL() {
    ...
    m_texture_shader = ShaderLoader::createShaderProgram("/Users/Luke/cs1230/projects-realtime-lukegriley/resources/shaders/texture.vert",
                                                         "/Users/Luke/cs1230/projects-realtime-lukegriley/resources/shaders/texture.frag");
...
void Realtime::initializeScene(std::string filepath) {
...
//            std::cerr << "Trimeshes not yet supported." << std::endl;
            Trimesh trimesh;
...
void Realtime::paintTexture(GLuint texture, bool includePost){
    glUseProgram(m_texture_shader);
...
void Realtime::paintGeometry() {
    ...
    //        glm::mat4 proj = glm::perspective(c.getHeightAngle(),c.getAspectRatio(),settings.nearPlane,settings.farPlane);
...
void Realtime::handleMovement(float deltaTime) {
